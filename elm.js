		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Formalizing Differential Privacy'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Defense Presentation'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Layout$href('https://github.com/madsbuch/thesis'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Download Zip'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {mdl: _debois$elm_mdl$Material$model, raised: -1},
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$card = F7(
	function (model, k, title, descr, btnUrl, btnT, imgUrl) {
		return A2(
					...
					},
					{
							...
							_debois$elm_mdl$Material_Card$title,
							{
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										'url(\'',
										A2(_elm_lang$core$Basics_ops['++'], imgUrl, '\') center / cover'))),
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(descr),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
										...
										_0: A5(
											...
											model.mdl,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Button$link(btnUrl),
														_1: {ctor: '[]'}
													}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(btnT),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Abstract'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Main$abstract,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$layout = function (model) {
	return _debois$elm_mdl$Material_Scheme$top(
		A4(
			...
			},
			{
				...
				main: _user$project$Main$top(model)
			}));
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init,
		view: _user$project$Main$layout,
